      ...
      <section className="px-5 pt-8 pb-4">
        <div className="max-container">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.5 }}
            ...
            <Image src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1200&q=80" alt="Customer Support Team" fill className="object-cover" />
          </motion.div>
        </div>
      </section>
